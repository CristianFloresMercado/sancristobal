<head>
    <script>
        // Force light mode on public pages unless user explicitly chose dark
        (function(){
    ...
    <!-- BS4 → BS5 compat shim (for style.css + Blade views) -->
    <style>
        /* Spacing: mr→me, ml→ms, pr→pe, pl→ps */
        ...
        .custom-control,.custom-select,.custom-file,.custom-range,.custom-range{position:relative;z-index:1;display:inline-block;min-height:1.5rem;padding-left:1.5rem;vertical-align:middle}
        .custom-control-input{position:absolute;left:0;z-index:-1;opacity:0;width:1rem;height:1.25rem}
        .custom-control-label{position:relative;margin-bottom:0;vertical-align:top;padding-left:.5rem}
        .custom-select{display:inline-block;width:100%;padding:.375rem 1.75rem .375rem .75rem;border:1px solid #ced4da;border-radius:.25rem;background-color:#fff;appearance:none}
        .custom-select-sm{padding-top:.25rem;padding-bottom:.25rem;padding-right:1.5rem;font-size:.875rem;border-radius:.2rem}
        .custom-file{position:relative;display:inline-block;width:100%;height:calc(1.5em + .75rem + 2px);margin-bottom:0}
        .custom-file-input{position:relative;z-index:2;width:100%;height:calc(1.5em + .75rem + 2px);margin:0;overflow:hidden;opacity:0}
        .custom-file-label{position:absolute;top:0;right:0;left:0;z-index:1;height:calc(1.5em + .75rem + 2px);padding:.375rem .75rem;border:1px solid #ced4da;border-radius:.25rem;background-color:#fff;color:#495057}
        .custom-range{width:100%;background-color:transparent;appearance:none}
        .custom-range::-webkit-slider-thumb{width:1rem;height:1rem;background-color:#0d6efd;border:.25rem solid #fff;border-radius:1rem;appearance:none}
        .custom-range::-webkit-slider-runnable-track{width:100%;height:.25rem;color:transparent;cursor:pointer;background-color:#dee2e6;border-color:transparent;border-radius:1rem}
        .custom-range:focus{outline:0}
        .custom-range:focus-visible::-webkit-slider-thumb{box-shadow:0 0 0 1px #fff,0 0 0 .25rem rgba(13,110,253,.25)}
    ...
    <!-- JS: jQuery + Bootstrap 5 (single copy) -->
