<x-layouts.app>
    <div class="container-fluid">
        <div class="page-header mb-4">
            <div class="page-title d-flex align-items-center justify-content-between flex-wrap gap-2">
                <div>
                    <h4>Editar Sitio Turístico</h4>
                    <p class="text-muted mb-0">Actualiza la información del sitio</p>
                </div>
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body">
                <form action="{{ route('admin.tourists.update', $tourist) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row g-3">
                        <div class="col-12 text-center">
                            <img id="preview-image"
                                src="{{ $tourist->imagen_destacada ? asset('storage/' . $tourist->imagen_destacada) : 'https://thumb.ac-illust.com/b1/b170870007dfa419295d949814474ab2_t.jpeg' }}"
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="titulo" value="{{ old('titulo', $tourist->titulo) }}"
                                class="form-control">
                            @error('titulo')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="ubicacion" value="{{ old('ubicacion', $tourist->ubicacion) }}"
                                class="form-control">
                            @error('ubicacion')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        ...
                        <div class="col-12">
                            ...
                            @if($tourist->imagenes && $tourist->imagenes->count())
                                <div class="d-flex flex-wrap gap-2 mb-2">
                                    @foreach($tourist->imagenes as $img)
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="latitud" id="latitud" value="{{ old('latitud', $tourist->latitud) }}" class="form-control">
                            @error('latitud')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="longitud" id="longitud" value="{{ old('longitud', $tourist->longitud) }}" class="form-control">
                            @error('longitud')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="horario" value="{{ old('horario', $tourist->horario) }}"
                                class="form-control">
                            @error('horario')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="resumen" rows="4" class="form-control">{{ old('resumen', $tourist->resumen) }}</textarea>
                            @error('resumen')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="d-flex gap-4 mt-1">
                                <div class="form-check">
                                    <input type="radio" name="publicado" value="1" class="form-check-input" id="pubSi"
                                        {{ old('publicado', $tourist->publicado) ? 'checked' : '' }}>
                        ...
                        <div class="col-12 text-end">
                            <button type="submit" class="btn btn-primary px-4">
                                <i class="bx bx-save me-1"></i>Actualizar Sitio
                            </button>
                        </div>
                    </div>
                </form>
    ...
    <script>
        function initMapa() {
            ...
            let latInicial = {{ $tourist->latitud ?? '-21.154317257395107' }};
            let lngInicial = {{ $tourist->longitud ?? '-67.16457366943361' }};
        ...
        function eliminarImagen(id, containerId) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    fetch('/admin/tourists/imagen/' + id, {
                        method: 'DELETE',
                        headers: {
