        ...
        <div class="page-header mb-4">
            <div class="page-title d-flex align-items-center justify-content-between flex-wrap gap-2">
                <div>
                    ...
                    <p class="text-muted mb-0">Registra una nueva institución en el portal</p>
                </div>
                ...
                <form action="{{ route('admin.instituciones.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="horario" value="{{ old('horario') }}" class="form-control" placeholder="Ej: Lunes a Viernes 8:00 - 17:00">
                            @error('horario')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <img id="imagenPreview" class="mt-3 rounded border d-none" style="width: 150px; height: 100px; object-fit: cover;">
                            @error('imagen')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-3 d-flex align-items-end">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="publicado" value="1" id="publicado" {{ old('publicado') ? 'checked' : '' }}>
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="number" name="orden" value="{{ old('orden', 0) }}" class="form-control" min="0">
                            @error('orden')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        ...
                        <div class="col-12 text-end">
                            <button type="submit" class="btn btn-success px-4">
                                <i class="bx bx-save me-1"></i>Guardar Institución
                            </button>
                        </div>
                    </div>
                </form>
