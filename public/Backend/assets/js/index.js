...
if (el2) {
  ...
  var myChart = new Chart(ctx, {
    ...
    data: {
      ...
      datasets: [{
        backgroundColor: [gradientStroke1, gradientStroke2, gradientStroke3, gradientStroke4],
        hoverBackgroundColor: [gradientStroke1, gradientStroke2, gradientStroke3, gradientStroke4],
        data: [25, 80, 25, 25],
        borderWidth: [1, 1, 1, 1]
      }]
    },
...
// world map
var elMap = document.getElementById('geographic-map-2');
if (elMap) {
  jQuery('#geographic-map-2').vectorMap({
    ...
    markerStyle: {
      initial: { r: 9, 'fill': '#fff', 'fill-opacity': 1, 'stroke': '#000', 'stroke-width': 5, 'stroke-opacity': 0.4 }
    },
    enableZoom: true,
    hoverColor: '#009efb',
...
// chart 3
var el3 = document.getElementById('chart3');
if (el3) {
...
// chart 4
var el4 = document.getElementById("chart4");
if (el4) {
  var ctx = el4.getContext('2d');
  var gradientStroke1 = ctx.createLinearGradient(0, 0, 0, 300);
...
// chart 5
var el5 = document.getElementById("chart5");
if (el5) {
  var ctx = el5.getContext('2d');
  var gradientStroke1 = ctx.createLinearGradient(0, 0, 0, 300);
